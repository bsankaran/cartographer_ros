...
-- Correlative scan matching is more expensive but may be more robust
...
TRAJECTORY_BUILDER_3D.submaps.num_range_data = NUM_SCANS_PER_SUBMAP
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 4e1
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.rotation_weight = 2e1
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher_3d.rotation_weight = 5e-2
